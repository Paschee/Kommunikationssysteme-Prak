...
import tests.test2.stack.layer.idu.IT_IDU
import tests.test2.stack.layer.idu.IU_IDU
import tests.test2.stack.layer.idu.LI_IDU
import tests.test2.stack.layer.idu.TRI_IDU
...
class IpLayer {
    ...
    void receive() {
        ...
        while (run) {
            ...
            // Ist das Paket an eine der eigenen IP-Adresse adressiert
    ...
    /**
     * Sucht den Ausgangs-Anschluss (Link-Port) passend zur Route
     ...
     * @return Liste: IP-v4-Adresse des nächsten Gerätes (hop) und Link-Port-Name oder "null"
     */
